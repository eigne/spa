...
class StatementProcedureNameAttribute : public IStatementAttribute {
private:
    std::shared_ptr<StatementWithProcedureName> synonym;
public:
    explicit StatementProcedureNameAttribute(std::shared_ptr<StatementWithProcedureName> synonym);
