...
#include "query_processing_system/query/design_entities/with_ref/attributes/statement_number/EntityWithStatementNumber.h"

class EntityStatementNumberAttribute : public IEntityAttribute {
private:
    std::shared_ptr<EntityWithStatementNumber> synonym;
public:
    explicit EntityStatementNumberAttribute(std::shared_ptr<EntityWithStatementNumber> synonym);
