...
class StatementVariableNameAttribute : public IStatementAttribute {
private:
    std::shared_ptr<StatementWithVariableName> synonym;
public:
    explicit StatementVariableNameAttribute(std::shared_ptr<StatementWithVariableName> synonym);
